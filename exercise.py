...
for dado_do_usuario in propaganda_online: 
    paises = ['turnisia', 'nauru', 'san marino','iceland','ghana']
    print(paises)
    
    ## exercise 1.2##
    leads =  [ 
              {'user': 'pedro', 'idade': 35, 'renda_area': 1200.00},
             {'user': 'pedro', 'idade': 35, 'renda_area': 4.500},
             {'user': 'pedro', 'idade': 35, 'renda_area': 61833.9,},
             {'user': 'pedro', 'idade': 35, 'renda_area': 8933.90},
             {'user': 'pedro', 'idade': 35, 'renda_area': 4833.90},
             {'user': 'pedro', 'idade': 35, 'renda_area': 2833.90},
             {'user': 'pedro', 'idade': 35, 'renda_area': 9833.90},
            ]

  for user_date in leads:
   ...
   city = 5
   second = 70
   date = [{'city:lisboa,' 'second: 75'},{'city:lebron,' 'second: 60'},{'city:santa luzia,' 'second: 80'}
           {'city:new york,' 'second: 90'},{'city:sabará,' 'second: 8'},{'city:paris,' 'second: 85'}]
try:
 time= second [0,70]
print(city)
 except Exception as exc:
print('date: ' + str(EXCEPTION))
print('time: ' + str(type(EXCEPTION)))
